...
import { UserProductsComponent } from './pages/client/user-products/user-products.component'; // Asegúrate de tener este componente
...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'profile/products', component: UserProductsComponent, pathMatch: 'full', data: { animation: 'HomePage' }, title: `${titleGlobal} Mis Productos`},
            { path: 'profile/edit-product-page/:id', component: EditProductPageComponent },
            ...
            { path: 'propose-exchange/:id', component: ProposeExchangePagesComponent, pathMatch: 'full', data: { animation: 'HomePage' }, title: `${titleGlobal} Postular Intercambio`}
        ]
    },
    {
